...
FORBIDDEN_SIDE_EFFECTS = [
    ...
    "review bypass",
    "summary export artifact mutation",
...
def test_golden_generated_case_human_review_decision_audit_handoff_names_surfaces() -> None:
...
def test_golden_generated_case_human_review_decision_audit_handoff_has_required_terms() -> None:
    fixture = _read(FIXTURE_PATH)
    slice_plan = _read(SLICE_PATH)
    contracts = _contracts_text()
...
def test_golden_generated_case_human_review_decision_audit_handoff_locks_api_payload_fields() -> None:
    fixture = _read(FIXTURE_PATH)
    ...
    _assert_normalized_contains(
        api_contract,
        "Generated Case Human Review Decision Audit Handoff response shape",
    )
...
def test_golden_generated_case_human_review_decision_audit_handoff_forbids_runtime_side_effects() -> None:
    fixture = _read(FIXTURE_PATH)
    contracts = _contracts_text()
    ...
    _assert_normalized_contains(
        api_contract, "successful ReviewHistory decision"
    )
    _assert_normalized_contains(
    ...
    _assert_normalized_contains(
        ...
        (
            ...
            "when the audit handoff evidence is produced by a prompt or skill"
        ),
    )
    _assert_normalized_contains(
        prompt_skill_contract, "evidence-chain packages only"
    )
    _assert_normalized_contains(
...
def _alias(term: str) -> str:
    aliases = {
        ...
        "generated case human review decision audit handoff id": (
            "Generated case human review decision audit handoff id or handoff artifact id"
        ),
        "handoff artifact id": "handoff artifact id",
        "generated_case_human_review_decision_audit_handoff_artifact_id": (
            "generated_case_human_review_decision_audit_handoff_artifact_id"
        ),
        "artifact_type=generated_case_human_review_decision_audit_handoff": (
        ...
        "GeneratedCaseCandidate ids/statuses": "GeneratedCaseCandidate ids/statuses",
