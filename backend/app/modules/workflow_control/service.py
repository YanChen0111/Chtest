...
def _exact_requirement_review_route(
    ...
    if stage is ControlledStage.REPORT_REVIEW:
        return (
    ...
    if stage is ControlledStage.AUTOMATION_DRAFT_REVIEW:
        return (
    ...
    if stage is not ControlledStage.REQUIREMENT_REVIEW:
        route += f"&workflow_stage={stage.value}"
    return route
