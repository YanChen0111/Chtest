...
After this task, Chtest has a closed Slice 55 handoff with Task 1-3 commits
recorded, the focused Generated Case Human Review Decision golden smoke
verified, and the next narrow V2 slice selected.
...
5. `backend/app/tests/golden/test_generated_case_human_review_decision_contract_golden.py`
6. `docs/fixtures/43-generated-case-human-review-decision-golden.md`
