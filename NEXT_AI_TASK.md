...
- Broad architecture, migration, enterprise collaboration, marketplace,
  distributed execution, cloud CI/provider integration, RBAC, tenants, and
  permissions docs unless a concrete blocker requires them.
...
or tests. Do not start a broad V2 platform expansion.

## Verification Command

```bash
rg -n "V2|Next|small slice|Candidate|JMeter|Local" docs/implementation/10-v2-scope-options.md docs/implementation/slices/slice-22-jmeter-local-execution.md NEXT_AI_TASK.md
git diff --check
```
