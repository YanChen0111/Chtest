...
| Add review history model and service | done | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_review_history.py -q` | pending | append-only local events |
