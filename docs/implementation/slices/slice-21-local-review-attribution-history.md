...
| Define review history contract boundary | done | `rg -n "ReviewHistory|review history|review attribution|Default User|RBAC|permissions" docs/contracts docs/implementation/slices/slice-21-local-review-attribution-history.md` | pending | contract-only before code |
