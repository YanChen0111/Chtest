...
|---|---|---|---|---|
| Add Case Metrics backend calculation | planned | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_case_metrics.py -q` | - | generated_count, approved_count, rejected_count, acceptance_rate, edit_rate, review_progress |
