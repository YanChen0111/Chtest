...
| Add CI/CD run create/list/get API | done | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_cicd_quality_center.py -q` | pending commit | `/api/cicd/runs` local_diff only |
