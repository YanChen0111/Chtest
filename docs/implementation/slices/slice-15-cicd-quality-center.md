...
| Add local diff parser service | done | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_cicd_quality_center.py -q` | pending commit | deterministic parser for unified diff text |
