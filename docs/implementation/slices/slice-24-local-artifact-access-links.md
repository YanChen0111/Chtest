...
|---|---|---|---|---|
| Add Local Artifact Access Links task plan | done | `test -f docs/implementation/slices/slice-24-local-artifact-access-links.md && rg -n "Local Artifact Access Links|artifact|download|Non-goals|Task Table" docs/implementation/slices/slice-24-local-artifact-access-links.md docs/implementation/10-v2-scope-options.md NEXT_AI_TASK.md` | pending | planning-only scope |
| Define local artifact access contract | planned | `rg -n "artifact access|download|GET /api/artifacts|Artifact" docs/contracts/02-api-contract.md docs/contracts/04-artifact-contract.md docs/implementation/slices/slice-24-local-artifact-access-links.md && git diff --check` | pending | contract-only |
