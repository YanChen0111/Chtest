...
| Add artifact access golden smoke | done | `backend/.venv/bin/python -m pytest backend/app/tests/golden/test_artifact_access_golden.py -q` | pending | evidence open proof |
