...
| Add Generated Case Human Review Decision Audit Handoff golden smoke | done | `backend/.venv/Scripts/python.exe -m pytest backend/app/tests/golden/test_generated_case_human_review_decision_audit_handoff_contract_golden.py -q && git diff --check` | pending | no approval/promotion/runtime/report/export integration |
