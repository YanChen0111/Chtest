...
| Define execution evidence summary contract | planned | `rg -n "execution evidence summary|evidence summary|download|missing evidence" docs/contracts/02-api-contract.md docs/contracts/04-artifact-contract.md docs/implementation/slices/slice-25-execution-evidence-summary.md && git diff --check` | pending | contract-only |
