...
|---|---|---|---|---|
| Add Requirement Review models and migration | planned | `backend/.venv/bin/python -m pytest backend/app/tests/db/test_requirement_review_models.py -q` | - | Requirement, RequirementReview, RiskItem |
