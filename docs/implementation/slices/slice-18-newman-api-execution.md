...
| Add Newman runner/parser backend | done | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_newman_execution.py -q` | `56ad111` | allowlisted local runner |
