...
| Add AutomationDraft model and schema alignment | done | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_automation_draft.py -q` | pending commit | model/schema/read contracts only |
