...
| Add CI/CD quality report API | done | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_unit_test_patch_regression.py -q` | pending commit | Report with report_type=cicd_quality |
