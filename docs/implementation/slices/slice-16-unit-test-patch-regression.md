...
|---|---|---|---|---|
| Add UnitTestPatch And Regression task plan | done | `test -f docs/implementation/slices/slice-16-unit-test-patch-regression.md && rg -n "UnitTestPatch|PatchScopeGate|Verification Command|Non-goals" docs/implementation/slices/slice-16-unit-test-patch-regression.md` | pending commit | scoped Slice 16 plan |
| Add UnitTestPatch and regression contract boundary | planned | `rg -n "UnitTestPatch|PatchScopeGate|QualityGateDecision|run-new-tests|run-regression" docs/contracts/01-data-model-contract.md docs/contracts/02-api-contract.md docs/contracts/03-state-machines.md docs/contracts/04-artifact-contract.md docs/implementation/slices/slice-16-unit-test-patch-regression.md` | - | contract-first Slice 16 subset |
| Add UnitTestPatch and QualityGateDecision model/schema | planned | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_unit_test_patch_regression.py -q` | - | persistence only |
