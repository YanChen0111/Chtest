...
| Add PatchScopeGate service | done | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_unit_test_patch_regression.py -q` | pending commit | blocks non-test path changes |
