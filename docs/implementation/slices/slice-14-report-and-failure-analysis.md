...
| Add automation execution Report API | done | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_report_failure_analysis.py -q` | pending commit | evidence_manifest + report artifacts |
