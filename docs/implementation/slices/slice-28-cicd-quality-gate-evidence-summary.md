...
| Add quality gate evidence summary golden smoke | done | `backend/.venv/bin/python -m pytest backend/app/tests/golden/test_cicd_quality_gate_evidence_summary_golden.py -q && git diff --check` | pending | evidence-only proof |
