...
| Add CI/CD quality gate frontend summary | done | `npm --prefix frontend run test -- --run src/views/cicd/CicdQualityCenterView.spec.ts && npm --prefix frontend run build && git diff --check` | pending | CI/CD page only |
