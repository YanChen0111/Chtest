...
| Add KnowledgeAdapter empty interface/schema | done | `backend/.venv/bin/python -m pytest backend/app/tests/api/test_extension_surface.py -q` | pending commit | no retrieval runtime |
