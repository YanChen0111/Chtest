...
| Add generated-case knowledge evidence golden smoke | done | `backend/.venv/bin/python -m pytest backend/app/tests/golden/test_generated_case_knowledge_evidence_persistence_golden.py -q && git diff --check` | pending | end-to-end proof |
