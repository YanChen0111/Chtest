...
Chtest V1 当前定位是面向个人测试工程师、自动化测试工程师的 AI 测试证据工作台，不是企业协作测试管理平台。任何新会话都必须以 memory、contracts、fixtures 文档为准，不依赖聊天上下文。
...
当前定位是个人测试/自动化测试工程师的 AI 测试证据工作台，不是企业协作测试管理平台。
