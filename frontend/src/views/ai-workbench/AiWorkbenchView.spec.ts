    ...
    groups: {
      ...
      waiting_approval: [
        ...
        },
        {
          ...
          project_id: '00000000-0000-0000-0000-000000000101',
          workflow_kind: 'requirement_to_execution',
          subject_ref: '00000000-0000-0000-0000-000000000605',
          current_stage: 'test_plan_review',
          gate_state: 'waiting_approval',
          bucket: 'waiting_approval',
          lock_version: 7,
          current_snapshot_id: '00000000-0000-0000-0000-000000009105',
          input_snapshot_hash: 'sha256:eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',
          approval_decision_id: null,
          can_continue: false,
          route_path: '/requirements/review?requirement_id=00000000-0000-0000-0000-000000000405&requirement_review_id=00000000-0000-0000-0000-000000000605&workflow_run_id=00000000-0000-0000-0000-000000009005&workflow_stage=test_plan_review',
          created_at: '2026-07-30T08:02:45Z',
          updated_at: '2026-07-30T08:03:45Z',
        },
        {
          id: '00000000-0000-0000-0000-000000009006',
          project_id: '00000000-0000-0000-0000-000000000101',
          workflow_kind: 'requirement_to_execution',
          subject_ref: '00000000-0000-0000-0000-000000000606',
          current_stage: 'case_review',
          gate_state: 'waiting_approval',
          bucket: 'waiting_approval',
          lock_version: 9,
          current_snapshot_id: '00000000-0000-0000-0000-000000009106',
          input_snapshot_hash: 'sha256:ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff',
          approval_decision_id: null,
          can_continue: false,
          route_path: '/cases/generation-review?requirement_id=00000000-0000-0000-0000-000000000406&requirement_review_id=00000000-0000-0000-0000-000000000606&workflow_run_id=00000000-0000-0000-0000-000000009006&workflow_stage=case_review',
          created_at: '2026-07-30T08:02:50Z',
          updated_at: '2026-07-30T08:03:50Z',
        },
        {
          id: '00000000-0000-0000-0000-000000009007',
          project_id: '00000000-0000-0000-0000-000000000101',
          workflow_kind: 'requirement_to_execution',
          subject_ref: '00000000-0000-0000-0000-000000000607',
          current_stage: 'automation_plan_review',
          gate_state: 'waiting_approval',
          bucket: 'waiting_approval',
          lock_version: 10,
          current_snapshot_id: '00000000-0000-0000-0000-000000009107',
          input_snapshot_hash: 'sha256:abababababababababababababababababababababababababababababababab',
          approval_decision_id: null,
          can_continue: false,
          route_path: '/automation/drafts?requirement_id=00000000-0000-0000-0000-000000000407&requirement_review_id=00000000-0000-0000-0000-000000000607&workflow_run_id=00000000-0000-0000-0000-000000009007&workflow_stage=automation_plan_review',
          created_at: '2026-07-30T08:02:55Z',
          updated_at: '2026-07-30T08:03:55Z',
        },
        {
          id: '00000000-0000-0000-0000-000000009008',
          project_id: '00000000-0000-0000-0000-000000000101',
          workflow_kind: 'requirement_to_execution',
          subject_ref: '00000000-0000-0000-0000-000000000608',
          current_stage: 'automation_draft_review',
          gate_state: 'waiting_approval',
          bucket: 'waiting_approval',
          lock_version: 11,
          current_snapshot_id: '00000000-0000-0000-0000-000000009108',
          input_snapshot_hash: 'sha256:cdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcdcd',
          approval_decision_id: null,
          can_continue: false,
        ...
        {
          id: '00000000-0000-0000-0000-000000009010',
          project_id: '00000000-0000-0000-0000-000000000101',
          workflow_kind: 'requirement_to_execution',
          subject_ref: '00000000-0000-0000-0000-000000000610',
          current_stage: 'execution_result_review',
          gate_state: 'waiting_approval',
          bucket: 'waiting_approval',
          lock_version: 13,
          current_snapshot_id: '00000000-0000-0000-0000-000000009110',
          input_snapshot_hash: 'sha256:efefefefefefefefefefefefefefefefefefefefefefefefefefefefefefefef',
          approval_decision_id: null,
          can_continue: false,
          route_path: '/reports/failure-analysis?requirement_id=00000000-0000-0000-0000-000000000410&requirement_review_id=00000000-0000-0000-0000-000000000610&workflow_run_id=00000000-0000-0000-0000-000000009010&workflow_stage=execution_result_review',
          created_at: '2026-07-30T08:03:10Z',
          updated_at: '2026-07-30T08:04:10Z',
        },
      ],
      can_continue: [
        {
...
describe('AiWorkbenchView', () => {
  ...
  it('loads recent AI tasks and shows selected task evidence details', async () => {
    ...
    expect(wrapper.text()).toContain('测试计划评审');
    ...
    expect(wrapper.text()).toContain('执行结果评审');
    ...
    expect(wrapper.findAll('[data-test="workflow-queue-open"]').map((link) => link.attributes('href'))).toEqual([
      ...
      '/requirements/review?requirement_id=00000000-0000-0000-0000-000000000405&requirement_review_id=00000000-0000-0000-0000-000000000605&workflow_run_id=00000000-0000-0000-0000-000000009005&workflow_stage=test_plan_review',
